...
<main class="main">
<h2>List of auto, sorted by model:</h2>
<table border="1">
    <!--  // вывод «шапки» таблицы -->
    <thead>
        <tr class='sticky'>
    ...
    $sql_add = "Select * from " . $_GET['table9']; 
        ...
        // print($sql_add);
        $result = $mysqli->query('SELECT * FROM auto order by model'); // запрос на выборку сведений о пользователях
